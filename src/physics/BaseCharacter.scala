...
class BaseCharacter() {
  ...
  def physicalAttack(character1: BaseCharacter, character2: BaseCharacter): Unit = {
    var damage: Int = 0
  ...
  def mageAttack(character1: BaseCharacter, character2: BaseCharacter): Unit = {
    var damage: Int = 0
  ...
  def statUp(character: BaseCharacter): Unit = { //when you level up your stats will increase by 5
    this.attackPower += 5
    this.defense += 5
    this.magicAttack += 5
    this.magicDefense += 5
  ...
  def fight(char1: BaseCharacter, char2: BaseCharacter): Unit = {
    if (char1.currentHP > 0 || char2.currentHP > 0) { //both are alive
